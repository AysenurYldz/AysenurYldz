...
<div align="center">
  <img src="./assets/focus.svg" alt="Focus areas: Applied AI, Full Stack Engineering, Ship to Production" width="100%" />
</div>
...
<img src="./assets/rhythm-en.svg" width="100%" alt="Working rhythm: commits by hour of day and day of week" />

<sub>Read from <b>local git history</b>, so it counts the client work that lives in private repositories — municipal mobile apps, sports and facility systems, HR platforms, community sites. Refreshed by hand; the measurement date is printed on the panel.</sub>
...
<sub>GitHub's own contribution graph, generated by <code>tools/gen-contrib.mjs</code> and refreshed every morning by an Action in this repository — no third-party stats service, so nothing here can go down on someone else's server. It reads far lower than the panel above, and the reason is mechanical: GitHub credits a commit only when its author email is linked to the account, and most of my work was committed from shared client machines carrying their own git identity.</sub>
